...
отсутствующие или пустые `Source facts`/`Assumptions before action`, отсутствующий
или смешанный raw run, неверный Expected/action/cleanup order,
...
`0/0/0` и признак офлайн-очистки. Минимальная структурно полная карта проходит.
